...
import 'package:syntax_flutter_parser/plays/play2/play22.dart';
...
class Play21 extends StatefulWidget {
  const Play21({Key? key}) : super(key: key);

  @override
  State<Play21> createState() => _Play21State();
}

class _Play21State extends State<Play21> {
  ...
  late List wordList1;
  late List wordList2;
  late VideoPlayerController videoPlayerController21;
  @override
  void dispose() {
    videoPlayerController21.dispose();
    super.dispose();
  }
  ...
  inVideo(String word) async {
    ...
    videoPlayerController21 = VideoPlayerController.asset("assets/$a.mp4")
      ..addListener(() => setState(() {}))
      ..setLooping(false)
      ..initialize().then((value) {
        videoPlayerController21.play();
      });
  }
          ...
          children: [
            ...
            Positioned(
              ...
              child: SizedBox(
                  ...
                  child: videoPlayerController21.value.isInitialized
                      ? VideoPlayer(videoPlayerController21)
                      : const Center(
              ...
              InkWell(
                onTap: () {
                  if (box1.isEmpty || box2.isEmpty) {
                    ...
                    String p = getParseString(getSentence(), 2, 1);
