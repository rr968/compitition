...
import 'package:syntax_flutter_parser/plays/play2/play23.dart';
...
class Play22 extends StatefulWidget {
  const Play22({Key? key}) : super(key: key);

  @override
  State<Play22> createState() => _Play22State();
}

class _Play22State extends State<Play22> {
  ...
  late List wordList1;
  late List wordList2;
  late VideoPlayerController videoPlayerController22;
  @override
  void dispose() {
    videoPlayerController22.dispose();
    super.dispose();
  }
  ...
  inVideo(String word) async {
    ...
    videoPlayerController22 = VideoPlayerController.asset("assets/$a.mp4")
      ..addListener(() => setState(() {}))
      ..setLooping(false)
      ..initialize().then((value) {
        videoPlayerController22.play();
      });
  }
              ...
              InkWell(
                onTap: () {
                  if (box1.isEmpty || box2.isEmpty) {
                    ...
                    String p = getParseString(getSentence(), 2, 2);
