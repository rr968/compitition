...
class Play11 extends StatefulWidget {
  const Play11({Key? key}) : super(key: key);

  @override
  State<Play11> createState() => _Play11State();
}

class _Play11State extends State<Play11> {
  ...
  late List wordList1;
  late List wordList2;
  late VideoPlayerController videoPlayerController11;
  ...
  void initState() {
    ...
    videoPlayerController11 = VideoPlayerController.asset("assets/ale.mp4")
  ...
  inVideo(String word) async {
    ...
    videoPlayerController11 = VideoPlayerController.asset("assets/$a.mp4")
      ..addListener(() => setState(() {}))
      ..setLooping(false)
      ..initialize().then((value) {
        videoPlayerController11.play();
      });
  }
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                decoration: const BoxDecoration(
                                    image: DecorationImage(
                                        image: AssetImage("assets/Play12.png"),
                                        fit: BoxFit.fill)),
                                child: Align(
                                    alignment: Alignment.center,
                                    child: SizedBox(
                              ...
                              Container(
                                ...
                                decoration: const BoxDecoration(
                                    image: DecorationImage(
                                        image: AssetImage("assets/Play13.png"),
                                        fit: BoxFit.fill)),
                                child: Align(
                                    alignment: Alignment.center,
                                    child: SizedBox(
                              ...
                              Container(
                                ...
                                decoration: const BoxDecoration(
                                    image: DecorationImage(
                                        image: AssetImage("assets/Play11.png"),
                                        fit: BoxFit.fill)),
                                child: Align(
                                    alignment: Alignment.center,
                                    child: SizedBox(
              ...
              InkWell(
                onTap: () {
                  if (box1.isEmpty || box2.isEmpty) {
                    ...
                    String p = getParseString(getSentence(), 1, 1);
...
adfinal() async {
  ...
  final player = AudioCache(prefix: 'assets/');
  url = await player.load('vfinal.mp3');
  audioPlayer.play(url.path, isLocal: true);
}
...
tryagain() async {
  ...
  final player = AudioCache(prefix: 'assets/');
  url = await player.load('tryagain.mp3');
  audioPlayer.play(url.path, isLocal: true);
}
