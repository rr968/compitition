...
class Play13 extends StatefulWidget {
  const Play13({Key? key}) : super(key: key);

  @override
  State<Play13> createState() => _Play13State();
}

class _Play13State extends State<Play13> {
  ...
  late List wordList1;
  late List wordList2;
  late VideoPlayerController videoPlayerController13;
  ...
  void initState() {
    ...
    videoPlayerController13 = VideoPlayerController.asset("assets/ale.mp4")
  ...
  inVideo(String word) async {
    ...
    videoPlayerController13 = VideoPlayerController.asset("assets/$a.mp4")
      ..addListener(() => setState(() {}))
      ..setLooping(false)
      ..initialize().then((value) {
        videoPlayerController13.play();
      });
  }
          ...
          children: [
            ...
            Positioned(
              ...
              child: SizedBox(
                  ...
                  child: videoPlayerController13.value.isInitialized
                      ? VideoPlayer(videoPlayerController13)
                      : const Center()),
            ),
            Positioned(
              ...
              InkWell(
                onTap: () {
                  if (box1.isEmpty || box2.isEmpty) {
                    ...
                    String p = getParseString(getSentence(), 1, 3);
