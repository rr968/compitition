...
class Play12 extends StatefulWidget {
  const Play12({Key? key}) : super(key: key);

  @override
  State<Play12> createState() => _Play12State();
}

class _Play12State extends State<Play12> {
  ...
  void initState() {
    ...
    videoPlayerController12 = VideoPlayerController.asset("assets/ale.mp4")
  ...
  inVideo(String word) async {
    ...
    videoPlayerController12.initialize().then((value) {
      videoPlayerController12 = VideoPlayerController.asset("assets/$a.mp4")
        ..addListener(() => setState(() {}))
        ..setLooping(false)
        ..initialize().then((value) {
          videoPlayerController12.play();
        });
    });
  }
          ...
          children: [
            ...
            Positioned(
              ...
              child: SizedBox(
                  ...
                  child: videoPlayerController12.value.isInitialized
                      ? VideoPlayer(videoPlayerController12)
                      : const Center(
              ...
              InkWell(
                onTap: () {
                  if (box1.isEmpty || box2.isEmpty) {
                    ...
                    String p = getParseString(getSentence(), 1, 2);
