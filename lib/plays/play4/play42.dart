...
import 'package:syntax_flutter_parser/plays/play4/play43.dart';

import '../../fuctions.dart';
import '../../widget.dart';
import '../play1/play11.dart';

class Play42 extends StatefulWidget {
  const Play42({Key? key}) : super(key: key);

  @override
  State<Play42> createState() => _Play42State();
}

class _Play42State extends State<Play42> {
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                decoration: const BoxDecoration(
                                    image: DecorationImage(
                                        image: AssetImage("assets/Play43.png"),
                                        fit: BoxFit.fill)),
                                child: Align(
                                    alignment: Alignment.center,
                                    child: SizedBox(
                              ...
                              Container(
                                ...
                                decoration: const BoxDecoration(
                                    image: DecorationImage(
                                        image: AssetImage("assets/Play42.png"),
                                        fit: BoxFit.fill)),
                                child: Align(
                                    alignment: Alignment.center,
                                    child: SizedBox(
                              ...
                              Container(
                                ...
                                decoration: const BoxDecoration(
                                    image: DecorationImage(
                                        image: AssetImage("assets/Play41.png"),
                                        fit: BoxFit.fill)),
                                child: Align(
                                    alignment: Alignment.center,
                                    child: SizedBox(
              ...
              InkWell(
                onTap: () {
                  if (box1.isEmpty || box2.isEmpty) {
                    ...
                    String p = getParseString(getSentence(), 4, 2);
