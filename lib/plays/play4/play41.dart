...
class Play41 extends StatefulWidget {
  const Play41({Key? key}) : super(key: key);

  @override
  State<Play41> createState() => _Play41State();
}

class _Play41State extends State<Play41> {
              ...
              InkWell(
                onTap: () {
                  if (box1.isEmpty || box2.isEmpty) {
                    ...
                    String p = getParseString(getSentence(), 4, 1);
