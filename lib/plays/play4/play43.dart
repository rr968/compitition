...
class Play43 extends StatefulWidget {
  const Play43({Key? key}) : super(key: key);

  @override
  State<Play43> createState() => _Play43State();
}

class _Play43State extends State<Play43> {
              ...
              InkWell(
                onTap: () {
                  if (box1.isEmpty || box2.isEmpty) {
                    ...
                    String p = getParseString(getSentence(), 4, 3);
