...
class Play33 extends StatefulWidget {
  const Play33({Key? key}) : super(key: key);

  @override
  State<Play33> createState() => _Play33State();
}

class _Play33State extends State<Play33> {
              ...
              InkWell(
                onTap: () {
                  if (box1.isEmpty || box2.isEmpty) {
                    ...
                    String p = getParseString(getSentence(), 3, 3);
