...
import 'package:syntax_flutter_parser/plays/play3/play33.dart';

import '../../fuctions.dart';
import '../../widget.dart';
import '../play1/play11.dart';

class Play32 extends StatefulWidget {
  const Play32({Key? key}) : super(key: key);

  @override
  State<Play32> createState() => _Play32State();
}

class _Play32State extends State<Play32> {
              ...
              InkWell(
                onTap: () {
                  if (box1.isEmpty || box2.isEmpty) {
                    ...
                    String p = getParseString(getSentence(), 3, 2);
