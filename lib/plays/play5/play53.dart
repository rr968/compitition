...
class Play53 extends StatefulWidget {
  const Play53({Key? key}) : super(key: key);

  @override
  State<Play53> createState() => _Play53State();
}

class _Play53State extends State<Play53> {
              ...
              InkWell(
                onTap: () {
                  if (box1.isEmpty || box2.isEmpty) {
                    ...
                    String p = getParseString(getSentence(), 5, 3);
