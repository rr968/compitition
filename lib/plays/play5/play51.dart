...
import 'package:syntax_flutter_parser/plays/play5/play52.dart';
...
class Play51 extends StatefulWidget {
  const Play51({Key? key}) : super(key: key);

  @override
  State<Play51> createState() => _Play51State();
}

class _Play51State extends State<Play51> {
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                decoration: const BoxDecoration(
                                    image: DecorationImage(
                                        image: AssetImage("assets/Play53.png"),
                                        fit: BoxFit.fill)),
                                child: Align(
                                    alignment: Alignment.center,
                                    child: SizedBox(
                              ...
                              Container(
                                ...
                                decoration: const BoxDecoration(
                                    image: DecorationImage(
                                        image: AssetImage("assets/Play52.png"),
                                        fit: BoxFit.fill)),
                                child: Align(
                                    alignment: Alignment.center,
                                    child: SizedBox(
                              ...
                              Container(
                                ...
                                decoration: const BoxDecoration(
                                    image: DecorationImage(
                                        image: AssetImage("assets/Play51.png"),
                                        fit: BoxFit.fill)),
                                child: Align(
                                    alignment: Alignment.center,
                                    child: SizedBox(
              ...
              InkWell(
                onTap: () {
                  if (box1.isEmpty || box2.isEmpty) {
                    ...
                    String p = getParseString(getSentence(), 5, 1);
