...
class Play52 extends StatefulWidget {
  const Play52({Key? key}) : super(key: key);

  @override
  State<Play52> createState() => _Play52State();
}

class _Play52State extends State<Play52> {
              ...
              InkWell(
                onTap: () {
                  if (box1.isEmpty || box2.isEmpty) {
                    ...
                    String p = getParseString(getSentence(), 5, 2);
